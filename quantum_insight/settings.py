"""
Django settings for quantum_insight project.
...
ROOT_URLCONF = "quantum_insight.urls"
...
WSGI_APPLICATION = "quantum_insight.wsgi.application"
...
try:
    ...
    msg = "CRITICAL: Can't import `qi_production_apps.py`"
...
try:
    ...
    msg = """
    -------------------------- `qi_development_apps.py` file was not found.
